  ...
  return (
    <section ref={ref} className="relative overflow-hidden bg-gray-950 px-6 py-24">
      ...
      <div className="relative mx-auto max-w-2xl text-center">
        ...
        >
          <motion.a
            ...
            className="flex items-center gap-2 rounded-full bg-cyan-400 px-8 py-3 font-semibold text-gray-950 transition-colors hover:bg-cyan-300"
          >
          ...
          <motion.a
            ...
            className="flex items-center gap-2 rounded-full border border-cyan-400 px-8 py-3 font-semibold text-cyan-400 transition-colors hover:bg-cyan-400/10"
          >
      ...
      <motion.p
        ...
        className="mt-20 text-center text-sm text-gray-700"
      >
